...
export default function DataPreviewOverlay({ previews, inventory, onClose }: DataPreviewOverlayProps) {
  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-3 border-b border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 shrink-0">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-sm font-bold text-neutral-900 dark:text-white">Data Preview</h2>
            </div>
            {activeMeta && (
        ...
        {/* Bottom tab bar */}
        {tableKeys.length > 0 && (
          <div className="shrink-0 border-t border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-900">
            <div
              ref={tabBarRef}
              ...
              {tableKeys.map((key) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-semibold rounded-t-lg border border-b-0 whitespace-nowrap transition-colors ${
                      isActive
                        ? "bg-white dark:bg-neutral-950 text-red-600 dark:text-red-400 border-neutral-200 dark:border-neutral-700 -mb-px z-10"
                        : "bg-neutral-100 dark:bg-neutral-800 text-neutral-500 dark:text-neutral-400 border-transparent hover:bg-neutral-200 dark:hover:bg-neutral-700 hover:text-neutral-700 dark:hover:text-neutral-300"
                    }`}
                  >
